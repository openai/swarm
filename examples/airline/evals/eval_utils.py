...
def run_function_evals(assistant, test_cases, n=1, eval_path=None):
    correct_function = 0
    results = []
    ...
    for test_case in test_cases:
        ...
        for i in range(n):
            ...
            response = client.run(assistant=assistant, messages=test_case['conversation'], max_turns=1)
            ...
            if 'tool_calls' in output:
                ...
                print(f'\033[95mExpected function: \033[0m {test_case["function"]}, \033[95mGot: \033[0mNone')
