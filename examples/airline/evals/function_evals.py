...
if __name__ == "__main__":
    ...
    run_function_evals(triage_assistant, triage_test_cases, n,  eval_path='eval_results/triage_evals.json')

    # Run flight modification evals
    with open(flight_modification_cases, 'r') as file:
        flight_modification_cases = json.load(file)
    run_function_evals(flight_modification, flight_modification_cases, n,
